            ...
            <div class="swiper-wrapper">
                ...
                ?>
                    <div class="swiper-slide">
                        <a href="<?php echo base_url().'star/'.$this->common_model->get_star_slug_by_id($popular_actor['star_id']);?>"><img style="border-radius: 10%;" src="<?php echo $this->common_model->get_img('star', $popular_actor['star_id']); ?>" alt="<?php echo $popular_actor['star_name']; ?>_photo" onerror="this.onerror=null;this.src='<?php echo base_url('uploads/default_image/actor.jpg') ?>';" /></a>
